...
load_dotenv()
#os.environ["GROQ_API_KEY"]  # Ensure the API key is loaded
# -------------------
# 1. LLM
# -------------------
...
def get_stock_price(symbol: str) -> str:
    ...
    Args:
        symbol: Stock ticker symbol like AAPL, TSLA, GOOGL
    """
    try:
        url = (
...
def purchase_stock(symbol: str, quantity: int) -> str:
    ...
    if isinstance(decision, str) and decision.lower() == "yes":
        ...
        return f"CANCELLED: Purchase of {quantity} shares of {symbol} was declined by human."
